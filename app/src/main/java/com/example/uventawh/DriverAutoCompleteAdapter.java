...
public class DriverAutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    public DriverAutoCompleteAdapter(Context mContext, String url, HttpClientSync client1) {
        ...
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    ...
                    DriverAutoCompleteAdapter.GetTransportByFilterTask getTransportByFilterTask = new DriverAutoCompleteAdapter.GetTransportByFilterTask();
    ...
    private void getTransportByFilter(Context mContext, String filter){
        ...
        try {
            request.put("request", "getDriversByFilter");
...
//                progressBar.setVisibility(View.GONE);
            ...
            public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, byte[] responseBody) {
                ...
                for (int i = 0; i < response.length(); i++){
                    ...
                    if (client1.getStringFromJSON(response_item, "Name").equals("getDriversByFilter")) {

                        refDescs.clear();

                        JSONArray tasksJSON = new JSONArray();
                        try {
                            tasksJSON = (JSONArray) response_item.get("DriversByFilter");
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        ...
                        for (int j = 0; j < tasksJSON.length(); j++) {
                            ...
                            String refTransport = client1.getStringFromJSON(task_item, "RefDriver");
                            String descTransport = client1.getStringFromJSON(task_item, "DescDriver");
