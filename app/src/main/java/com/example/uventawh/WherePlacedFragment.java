 ...
 * Use the {@link WherePlacedFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class WherePlacedFragment extends Fragment {
     ...
     * @return A new instance of fragment WherePlacedFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static WherePlacedFragment newInstance(String param1, String param2) {
        WherePlacedFragment fragment = new WherePlacedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_where_placed, container, false);
    ...
    private void setActvShtrihCode(View root) {
        ...
        actvShtrihCode.setAdapter(new HttpAutoCompleteAdapter(getContext(), "getGoodsInCellsByFilter", new HttpAutoCompleteAdapter.OnProcessResponseListener() {
            @Override
            public void OnProcessResponse(HttpClientSync httpClientSync, List<RefDesc> refDescs, JSONObject response) {

                JSONArray cells = httpClientSync.getJsonArrayFromJsonObject(response, "Goods");
        ...
        actvShtrihCode.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                tvHeader.setText("Номенклатура: " + refDesc.desc);
    ...
    private void getGoodByName(final String description) {

        final HttpClient httpClient = new HttpClient(getContext());
        httpClient.addParam("description", description);

        httpClient.postForResult("getGoodByName", new HttpRequestInterface() {
            @Override
    ...
    private void getPlacedScanCodes(String ref, final String desc) {
        ...
        httpClient.postForResult("getWherePlacedScanCodes", new HttpRequestInterface() {
            @Override
            public void setProgressVisibility(int visibility) {
            ...
            public void processResponse(JSONObject response) {
                ...
                JSONArray goods = httpClient.getJsonArrayFromJsonObject(response, "Cells");
                ...
                tvHeader.setText("Номенклатура: " + desc + ", мест: " + scanCodes.size());
