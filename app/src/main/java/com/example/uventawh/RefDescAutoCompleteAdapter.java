...
public class RefDescAutoCompleteAdapter extends BaseAdapter implements Filterable {
    ...
    public RefDescAutoCompleteAdapter(Context mContext, String url, HttpClientSync client1) {
    ...
    private void getTransportByFilter(Context mContext, String filter){
        ...
        try {
            request.put("request", "getTransportByFilter");
...
//                progressBar.setVisibility(View.GONE);
            ...
            public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, byte[] responseBody) {
                ...
                for (int i = 0; i < response.length(); i++){
                    ...
                    if (client1.getStringFromJSON(response_item, "Name").equals("getTransportByFilter")) {

                        refDescs.clear();

                        JSONArray tasksJSON = new JSONArray();
                        try {
                            tasksJSON = (JSONArray) response_item.get("TransportByFilter");
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        ...
                        for (int j = 0; j < tasksJSON.length(); j++) {
                            ...
                            String refTransport = client1.getStringFromJSON(task_item, "RefTransport");
                            String descTransport = client1.getStringFromJSON(task_item, "DescTransport");
