...
//    private CheckBox cbNotLoaded, cbNew, cbToPlan, cbPlanedPartially, cbPlaned, cbToSelect, cbSelecting, cbSelected,
//            cbPacked, cbReadyToShip, cbShiped, cbCanceled, cbBlocked;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {

        deliveryListViewModel = new ViewModelProvider(this).get(DeliveryListViewModel.class);
        ...
        httpClient.postProc("getShipmentOrderContainer", new HttpRequestInterface() {
            ...
            public void processResponse(JSONObject response) {
                ...
                if (containerRef.isEmpty()) {
                    ...
                    bundle.putInt("next", R.id.deliveryOrderTestFragment);
...
//        cbNotLoaded.setChecked(deliveryListViewModel.getNotLoaded().getValue());
    ...
    protected void update2(){
        ...
        String curStatus = (deliveryListViewModel.getNotLoaded().getValue() ? "cbNotLoaded," : "")
