...
public class DataAcceptancesAdapter extends RecyclerView.Adapter<DataAcceptancesAdapter.TaskItemViewHolder> {

    private LayoutInflater inflater;
    private List<AcceptanceItem> phones;
        ...
        public TaskItemViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    AcceptanceItem taskItem = phones.get(getLayoutPosition());
    ...
    DataAcceptancesAdapter(Context context, List<AcceptanceItem> phones) {
        this.phones = phones;
    ...
    public interface OnTaskItemClickListener {
        void onTaskItemClick(AcceptanceItem taskItem, View itemView);
    }
    ...
    public void onBindViewHolder(@NonNull TaskItemViewHolder holder, int position) {
        AcceptanceItem phone = phones.get(position);
        //holder.imageView.setImageResource(phone.image);
        holder.companyView.setText(getMarked(phone.numDocument + (phone.numDocument.isEmpty() ? "" : ", ") + "№" + phone.number + " от " + phone.date));
