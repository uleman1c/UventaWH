...
public class DeliveryOrderProduct {
    ...
    public Integer scanned, quantity;

    public DeliveryOrderProduct(String ref, String status, String product, String shtrih_code, String product_status, String product_part, String container, String container_shtrih_code, Integer quantity) {
        this.ref = ref;
        this.status = status;
    ...
    public static DeliveryOrderProduct DeliveryOrderProductFromJSON(JSONObject js, HttpClient ht){
        ...
        return new DeliveryOrderProduct(ref, status, product, shtrih_code, product_status, product_part, container, container_shtrih_code, quantity);
    }
