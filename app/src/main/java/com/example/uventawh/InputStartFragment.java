 ...
 * Use the {@link InputStartFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InputStartFragment extends Fragment {
     ...
     * @return A new instance of fragment InputStartFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static InputStartFragment newInstance(String param1, String param2) {
        InputStartFragment fragment = new InputStartFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_input_start, container, false);
...
//        setTabHost(root);
        ...
        adapter = new DataInputStartAdapter(getContext(), items);
        adapter.setOnTaskItemClickListener(new DataInputStartAdapter.OnTaskItemClickListener() {
            @Override
            public void onTaskItemClick(InputStartItem taskItem, View itemView) {
...
//                update2();
        ...
        root.findViewById(R.id.btnAdd).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                bundle.putString("ref", emptyRef);
                bundle.putInt("next", R.id.newContainerFragment);
                bundle.putInt("next2", R.id.scanQuantityFragment);
                Navigation.findNavController(getActivity(), R.id.nav_host_fragment).navigate(R.id.scanCellFragment, bundle);
    ...
    protected void update(String sFilter){
        ...
        httpClient.postProc("getInputStartByStringFilter", new HttpRequestInterface() {
            @Override
            ...
            public void processResponse(JSONObject response) {
                ...
                JSONArray deliveryOrdersJSON = httpClient.getJsonArrayFromJsonObject(response, "InputStartByStringFilter");

                for (int k = 0; k < deliveryOrdersJSON.length(); k++) {

                    JSONObject deliveryOrderJSON = httpClient.getItemJSONArray(deliveryOrdersJSON, k);

                    items.add(InputStartItem.extractFromJSON(deliveryOrderJSON, httpClient));
                }
