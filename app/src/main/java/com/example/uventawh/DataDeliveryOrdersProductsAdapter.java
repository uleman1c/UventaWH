...
public class DataDeliveryOrdersProductsAdapter extends RecyclerView.Adapter<DataDeliveryOrdersProductsAdapter.TaskItemViewHolder> {
        ...
        public TaskItemViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    DeliveryOrderProduct taskItem = deliveryOrderProducts.get(getLayoutPosition());
    ...
    DataDeliveryOrdersProductsAdapter(Context context, List<DeliveryOrderProduct> phones) {
        this.deliveryOrderProducts = phones;
    ...
    public interface OnTaskItemClickListener {
        void onTaskItemClick(DeliveryOrderProduct taskItem, View itemView);
    }
    ...
    public TaskItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.delivery_order_products_list_item, parent, false);
        return new TaskItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TaskItemViewHolder holder, int position) {
        DeliveryOrderProduct phone = deliveryOrderProducts.get(position);
...
//        holder.tvPersent.setText(phone.quantity == 0 ? "" : Math.round(phone.accepted * 100 / phone.quantity) + "%");
    ...
    public int getItemCount() {
        return deliveryOrderProducts.size();
    }
